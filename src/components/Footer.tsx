...
export  function Footer(){
    return(
        <>
        <div className="footer overflow-x-hidden fixed buttom-0  w-full  mt-10 h-48 bg-amber-950  "> 
        ...
        <p className="fo bottom-0  text-amber-800 text-center bg-opacity-50 italic py-2 bg-white ">&copy; 2024 zharwy. All rights are reserved.</p>
        </div>
